...
namespace pcpp
{
	...
	pcpp::MacAddress WakeOnLanLayer::getTargetAddr() const { return pcpp::MacAddress(getWakeOnLanHeader()->addrBody); }
	...
	bool WakeOnLanLayer::setPassword(const MacAddress &addr) { return setPassword(addr.getRawData(), 6); }

	bool WakeOnLanLayer::setPassword(const IPv4Address &addr) { return setPassword(addr.toBytes(), 4); }
