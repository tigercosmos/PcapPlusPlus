...
#define FIRST_HASH 37 /* also prime */
	...
	SSLCipherSuite *SSLCipherSuite::getCipherSuiteByName(std::string name)
	{
		...
		std::unordered_map<uint32_t, SSLCipherSuite *>::const_iterator pos =
	...
	uint16_t SSLExtension::getTypeAsInt() const { return be16toh(getExtensionStruct()->extensionType); }

	uint16_t SSLExtension::getLength() const { return be16toh(getExtensionStruct()->extensionDataLength); }

	uint16_t SSLExtension::getTotalLength() const { return getLength() + 2 * sizeof(uint16_t); }
	...
	int SSLClientHelloMessage::getExtensionCount() const { return m_ExtensionList.size(); }
	...
	std::string SSLClientHelloMessage::toString() const { return "Client Hello message"; }
	...
	std::string SSLClientHelloMessage::ClientHelloTLSFingerprint::toMD5() { return toStringAndMD5().second; }
	...
	int SSLServerHelloMessage::getExtensionCount() const { return m_ExtensionList.size(); }
	...
	std::string SSLServerHelloMessage::toString() const { return "Server Hello message"; }
	...
	std::string SSLServerHelloMessage::ServerHelloTLSFingerprint::toMD5() { return toStringAndMD5().second; }
	...
	std::string SSLCertificateMessage::toString() const { return "Certificate message"; }

	int SSLCertificateMessage::getNumOfCertificates() const { return m_CertificateList.size(); }
	...
	std::string SSLHelloRequestMessage::toString() const { return "Hello Request message"; }

	// ---------------------------------
	// SSLServerHelloDoneMessage methods
	// ---------------------------------

	std::string SSLServerHelloDoneMessage::toString() const { return "Server Hello Done message"; }
	...
	std::string SSLServerKeyExchangeMessage::toString() const { return "Server Key Exchange message"; }
	...
	std::string SSLClientKeyExchangeMessage::toString() const { return "Client Key Exchange message"; }
	...
	std::string SSLCertificateRequestMessage::toString() const { return "Certificate Request message"; }
	...
	std::string SSLCertificateVerifyMessage::toString() const { return "Certificate Verify message"; }
	...
	std::string SSLNewSessionTicketMessage::toString() const { return "New Session Ticket message"; }
