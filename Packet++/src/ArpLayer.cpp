...
namespace pcpp
{
	...
	bool ArpLayer::isRequest() const { return be16toh(getArpHeader()->opcode) == pcpp::ArpOpcode::ARP_REQUEST; }

	bool ArpLayer::isReply() const { return be16toh(getArpHeader()->opcode) == pcpp::ArpOpcode::ARP_REPLY; }
