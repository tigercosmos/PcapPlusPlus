...
namespace pcpp
{
	...
	std::string BgpLayer::toString() const { return "BGP Layer, " + getMessageTypeAsString() + " message"; }
	...
	bool BgpUpdateMessageLayer::clearWithdrawnRoutes() { return setWithdrawnRoutes(std::vector<prefix_and_ip>()); }
	...
	bool BgpUpdateMessageLayer::clearPathAttributes() { return setPathAttributes(std::vector<path_attribute>()); }
