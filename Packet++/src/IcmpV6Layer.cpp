...
namespace pcpp
{
	...
	uint16_t IcmpV6Layer::getChecksum() const { return be16toh(getIcmpv6Header()->checksum); }
	...
	uint16_t ICMPv6EchoLayer::getIdentifier() const { return be16toh(getEchoHeader()->id); }

	uint16_t ICMPv6EchoLayer::getSequenceNr() const { return be16toh(getEchoHeader()->sequence); }
