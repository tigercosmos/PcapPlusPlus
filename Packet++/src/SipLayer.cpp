...
namespace pcpp
{
	...
	const std::unordered_map<std::string, SipRequestLayer::SipMethod> SipMethodStringToEnum{
		{"INVITE", SipRequestLayer::SipMethod::SipINVITE},	   {"ACK", SipRequestLayer::SipMethod::SipACK},
		{"BYE", SipRequestLayer::SipMethod::SipBYE},		   {"CANCEL", SipRequestLayer::SipMethod::SipCANCEL},
		{"REGISTER", SipRequestLayer::SipMethod::SipREGISTER}, {"PRACK", SipRequestLayer::SipMethod::SipPRACK},
		{"OPTIONS", SipRequestLayer::SipMethod::SipOPTIONS},   {"SUBSCRIBE", SipRequestLayer::SipMethod::SipSUBSCRIBE},
		{"NOTIFY", SipRequestLayer::SipMethod::SipNOTIFY},	   {"PUBLISH", SipRequestLayer::SipMethod::SipPUBLISH},
		{"INFO", SipRequestLayer::SipMethod::SipINFO},		   {"REFER", SipRequestLayer::SipMethod::SipREFER},
		{"MESSAGE", SipRequestLayer::SipMethod::SipMESSAGE},   {"UPDATE", SipRequestLayer::SipMethod::SipUPDATE},
	};
	...
	catch (const SipRequestFirstLineException &) { throw; }
	catch (...) { std::terminate(); }
	...
	const int StatusCodeEnumToInt[77] = {100, 180, 181, 182, 183, 199, 200, 202, 204, 300, 301, 302, 305, 380, 400, 401,
										 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417,
										 420, 421, 422, 425, 423, 424, 428, 429, 430, 433, 436, 437, 438, 439, 440, 469,
										 470, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 491, 493, 494, 500, 501,
										 502, 503, 504, 505, 513, 555, 580, 600, 603, 604, 606, 607, 608};
	...
	int SipResponseFirstLine::getStatusCodeAsInt() const { return StatusCodeEnumToInt[m_StatusCode]; }
