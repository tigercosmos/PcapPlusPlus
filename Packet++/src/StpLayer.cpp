...
namespace pcpp
{
	...
	uint16_t MultipleStpLayer::getMstConfigRevision() const { return be16toh(getMstpHeader()->mstConfigRevision); }

	void MultipleStpLayer::setMstConfigRevision(uint16_t value) { getMstpHeader()->mstConfigRevision = htobe16(value); }
