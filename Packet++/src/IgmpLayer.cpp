...
namespace pcpp
{
	...
	uint16_t IgmpV3QueryLayer::getSourceAddressCount() const { return be16toh(getIgmpV3QueryHeader()->numOfSources); }
	...
	uint16_t IgmpV3ReportLayer::getGroupRecordCount() const { return be16toh(getReportHeader()->numOfGroupRecords); }
	...
	uint16_t igmpv3_group_record::getSourceAddressCount() const { return be16toh(numOfSources); }
