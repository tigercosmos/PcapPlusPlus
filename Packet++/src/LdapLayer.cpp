...
namespace pcpp
{
	...
	static const std::unordered_map<LdapOperationType::Value, std::string, EnumClassHash<LdapOperationType::Value>>
		LdapOperationTypeToString{{LdapOperationType::BindRequest, "BindRequest"},
	...
	std::string LdapOperationType::toString() const { return LdapOperationTypeToString.at(m_Value); }
	...
	static const std::unordered_map<LdapResultCode::Value, std::string, EnumClassHash<LdapResultCode::Value>>
		LdapResultCodeToString{{LdapResultCode::Success, "Success"},
	...
	std::string LdapResultCode::toString() const { return LdapResultCodeToString.at(m_Value); }
	...
	Asn1SequenceRecord *LdapLayer::getRootAsn1Record() const { return m_Asn1Record->castAs<Asn1SequenceRecord>(); }
	...
	std::string LdapResponseLayer::getExtendedInfoString() const { return getResultCode().toString(); }
	// endregion
	...
	const std::unordered_map<LdapSearchRequestLayer::SearchRequestScope::Value, std::string,
		...
		SearchRequestScopeToString{{LdapSearchRequestLayer::SearchRequestScope::BaseObject, "BaseObject"},
	...
	const std::unordered_map<LdapSearchRequestLayer::DerefAliases::Value, std::string,
		...
		DerefAliasesToString{{LdapSearchRequestLayer::DerefAliases::NeverDerefAliases, "NeverDerefAliases"},
	...
	std::string LdapSearchRequestLayer::DerefAliases::toString() const { return DerefAliasesToString.at(m_Value); }
