...
namespace pcpp
{
	...
	struct LdapAttribute
	{
		 ...
		 * @return True if both values are equal, false otherwise
		 */
		bool operator==(const LdapAttribute &other) const { return type == other.type && values == other.values; }
	};
	...
	class LdapBindRequestLayer : public LdapLayer
	{
	  public:
		...
		struct SaslAuthentication
		{
			 ...
			 */
			bool operator!=(const SaslAuthentication &other) const { return !operator==(other); }
		};
