...
static struct option PcapSearchOptions[] = {{"input-dir", required_argument, nullptr, 'd'},
 ...
 */
std::string getExtension(const std::string &fileName) { return fileName.substr(fileName.find_last_of(".") + 1); }
