...
static struct option IcmpFTOptions[] = {
	{"interface", required_argument, nullptr, 'i'}, {"dest-ip", required_argument, nullptr, 'd'},
	{"send-file", required_argument, nullptr, 's'}, {"receive-file", no_argument, nullptr, 'r'},
	{"speed", required_argument, nullptr, 'p'},		{"block-size", required_argument, nullptr, 'b'},
	{"list-interfaces", no_argument, nullptr, 'l'}, {"help", no_argument, nullptr, 'h'},
	{"version", no_argument, nullptr, 'v'},			{nullptr, no_argument, nullptr, no_argument}};
