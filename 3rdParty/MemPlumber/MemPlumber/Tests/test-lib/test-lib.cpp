...
class LibInternalClass
{
  ...
  public:
	LibInternalClass() { m_DoubleMember = new double(999.888); }

	~LibInternalClass() { delete m_DoubleMember; }
};
...
size_t LibClass::getSizeOfInternalClass() { return sizeof(LibInternalClass) + sizeof(double); }
